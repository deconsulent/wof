...
(function (root, factory) {
    ...
    const DICTIONARIES = {
        en: {
            ...
            "gps_not_at_location_title": "Not at the Physical Location",
            "gps_distance_away_msg": "This Wall of Fame screen is located {dist} away from you at RTU.",
            "gps_preview_prompt": "Would you like to explore this screen in Remote Preview Mode?",
            "gps_enter_preview_btn": "⚡ Explore in Preview Mode ↗",
            "gps_preview_active_banner": "📍 REMOTE PREVIEW MODE · PHYSICAL SCREEN IS {dist} AWAY",
        ...
        lv: {
            ...
            "gps_not_at_location_title": "Jūs Neesat Fiziskajā Lokācijā",
            "gps_distance_away_msg": "Šis Goda Sienas ekrāns atrodas {dist} attālumā no jums RTU.",
            "gps_preview_prompt": "Vai vēlaties izpētīt šo ekrānu attālinātajā priekšskatījuma režīmā?",
            "gps_enter_preview_btn": "⚡ Izpētīt Priekšskatījuma Režīmā ↗",
            "gps_preview_active_banner": "📍 ATTĀLINĀTS PRIEKŠSKATĪJUMS · FIZISKAIS EKRĀNS IR {dist} ATTĀLUMĀ",
